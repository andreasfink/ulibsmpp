...
static dbFieldDef db_message_fields[] =
{
    ...
    { "RouterReference",        NULL,   NO,     DB_PRIMARY_INDEX,   DB_FIELD_TYPE_VARCHAR,              64,   0,NULL,NULL,2},
    { "ConnectionReference",    NULL,   NO,     DB_INDEXED,         DB_FIELD_TYPE_VARCHAR,              64,   0,NULL,NULL,3},
    { "UserReference",          NULL,   NO,     DB_INDEXED,         DB_FIELD_TYPE_VARCHAR,              64,   0,NULL,NULL,1},
    { "UserMessageReference",   NULL,   NO,     DB_INDEXED,         DB_FIELD_TYPE_VARCHAR,              4,   0,NULL,NULL,1},
    { "Type",                   NULL,   NO,     DB_INDEXED,         DB_FIELD_TYPE_VARCHAR,              32,   0,NULL,NULL,4},
    { "Method",                 NULL,   NO,     DB_INDEXED,         DB_FIELD_TYPE_VARCHAR,              32,   0,NULL,NULL,5},
    { "InboundMethod",          NULL,   NO,     DB_INDEXED,         DB_FIELD_TYPE_VARCHAR,              32,   0,NULL,NULL,6},
    { "Addr",                   NULL,   NO,     DB_INDEXED,         DB_FIELD_TYPE_VARCHAR,              32,   0,NULL,NULL,7},
    { "InboundType",            NULL,   NO,     DB_INDEXED,         DB_FIELD_TYPE_VARCHAR,              32,   0,NULL,NULL,8},
    { "InboundAddress",         NULL,   NO,     DB_INDEXED,         DB_FIELD_TYPE_VARCHAR,              32,   0,NULL,NULL,9},
    { "From",                   NULL,   NO,     DB_INDEXED,         DB_FIELD_TYPE_VARCHAR,              32,   0,NULL,NULL,10},
    { "To",                     NULL,   NO,     DB_INDEXED,         DB_FIELD_TYPE_VARCHAR,              32,   0,NULL,NULL,11},
    { "ReportTo",               NULL,   NO,     DB_INDEXED,         DB_FIELD_TYPE_VARCHAR,              32,   0,NULL,NULL,12},
    ...
    { "MessageState",           NULL,   NO,     DB_INDEXED,         DB_FIELD_TYPE_VARCHAR,              32,   0,NULL,NULL,30},
    ...
    { "Msc",                    NULL,   NO,     DB_INDEXED,         DB_FIELD_TYPE_VARCHAR,              32,   0,NULL,NULL,33},
    { "Smsc1",                  NULL,   NO,     DB_NOT_INDEXED,     DB_FIELD_TYPE_VARCHAR,              32,   0,NULL,NULL,34},
    { "Smsc2",                  NULL,   NO,     DB_NOT_INDEXED,     DB_FIELD_TYPE_VARCHAR,              32,   0,NULL,NULL,35},
    { "Smsc3",                  NULL,   NO,     DB_NOT_INDEXED,     DB_FIELD_TYPE_VARCHAR,              32,   0,NULL,NULL,36},
    { "Opc1",                   NULL,   NO,     DB_NOT_INDEXED,     DB_FIELD_TYPE_VARCHAR,              8,    0,NULL,NULL,37},
    { "Dpc1",                   NULL,   NO,     DB_NOT_INDEXED,     DB_FIELD_TYPE_VARCHAR,              8,    0,NULL,NULL,38},
    { "Opc2",                   NULL,   NO,     DB_NOT_INDEXED,     DB_FIELD_TYPE_VARCHAR,              8,    0,NULL,NULL,39},
    { "Dpc2",                   NULL,   NO,     DB_NOT_INDEXED,     DB_FIELD_TYPE_VARCHAR,              8,    0,NULL,NULL,40},
    { "Userflags",              NULL,   NO,     DB_NOT_INDEXED,     DB_FIELD_TYPE_INTEGER,             0,    0,NULL,NULL,41},
    { "Hlr",                    NULL,   NO,     DB_NOT_INDEXED,     DB_FIELD_TYPE_VARCHAR,              32,   0,NULL,NULL,42},
    { "Imsi",                   NULL,   NO,     DB_INDEXED,         DB_FIELD_TYPE_VARCHAR,              32,   0,NULL,NULL,43},
